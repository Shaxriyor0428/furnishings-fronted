...
const Info = () => {
    return (
        <div className=" bg-[#FAF3EA] font-poppins mt-20">
            <div className=" container">
                <div className=" flex justify-between h-[270px]">
                    <div className="flex gap-[10px] justify-center items-center">
                        <div className="w-[60px] h-[60px] grid place-items-center">
                            <img src={trophy} alt="" className="" />
                        </div>
                        <div className="flex flex-col gap-[2px] h-[70px]">
                            <p className="h-[38px] text-[#242424] font-semibold text-[25px] leading-[37.5px]">
                                High Quality
                            </p>
