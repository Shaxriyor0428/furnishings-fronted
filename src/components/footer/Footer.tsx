      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-8">
            ...
            <nav className="flex flex-col space-y-3">
              <a href="/paynet-options" className="text-gray-900 hover:underline">
                Payment Options
              </a>
              <a href="/returns" className="text-gray-900 hover:underline">
                Returns
              </a>
              <a href="/privacy-policies" className="text-gray-900 hover:underline">
                Privacy Policies
              </a>
            </nav>
          </div>
        ...
        <div className="mt-12 border-t border-gray-100 pt-8">
          <p className="text-gray-600">2023 furino. All rights reserved</p>
        </div>
      </div>
    </footer>
  )
