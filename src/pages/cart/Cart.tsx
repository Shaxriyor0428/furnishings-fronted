...
const Cart = () => {
  ...
  <div className=" dark:bg-zinc-800 p-3 rounded-t-lg">
    <table className="w-full table-auto text-left">
      <thead>
        <tr className="font-semibold text-base bg-[#F9F1E7] ">
      ...
      <tbody>
        {cart.length > 0 ? (
          cart.map((product: ICartProduct) => (
            <tr
              key={product.id}
              className="border-b hover:bg-gray-100 dark:hover:bg-zinc-700 transition"
            >
          ...
          <tr>
            <td colSpan={5} className="text-gray-500 text-lg text-center py-3 dark:text-white">
              Your cart is empty.
            </td>
          </tr>
        )}
